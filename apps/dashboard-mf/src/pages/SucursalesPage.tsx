  ...
  return (
    <article className="card card-hover flex flex-col gap-0 overflow-hidden">
      ...
      <div className="flex items-center justify-between border-t border-maison-border px-4 py-3">
        ...
        <button type="button" className="flex items-center gap-1.5 rounded border border-maison-border bg-surface-2 px-2.5 py-1 text-2xs font-medium text-maison-cream-muted transition-colors hover:bg-surface-3 hover:text-maison-cream" aria-label={`Editar ${branch.name}`}>
    ...
    <div className="flex flex-col gap-7 animate-fade-in">
      <header className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div className="flex items-center gap-2 self-start sm:self-auto">
          ...
          <button type="button" className="btn-primary"><IconPlus className="h-4 w-4" />Nueva sucursal</button>
        </div>
      </header>
