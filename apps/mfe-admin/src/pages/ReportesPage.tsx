...
export default function ReportesPage() {
  return (
    <div className="flex flex-col gap-6 animate-fade-in">
      <header><h1 className="font-display text-3xl font-medium text-maison-cream leading-none">Reportes</h1><p className="mt-1.5 text-sm text-maison-cream-muted">Reportes y métricas de la plataforma</p></header>
