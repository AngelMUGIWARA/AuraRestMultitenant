...
import { IconOrders, IconInventory } from '@maison/ui';
...
export default function ChefDashboardPage() {
  ...
  return (
    <div className="flex flex-col gap-6 h-full">
      {/* Encabezado en su posición original (izquierda) */}
      <div>
      ...
      {/* Contenedor que centra las tarjetas tanto horizontal como verticalmente */}
