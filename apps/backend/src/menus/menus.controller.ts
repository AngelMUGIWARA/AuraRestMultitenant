...
export class MenusController {
  ...
  create(
    ...
    return this.service.create(tenant.schemaName, dto, file);
  }
  ...
  update(
    ...
    return this.service.update(tenant.schemaName, id, dto, file);
  }
  ...
  @ApiResponse({
    status: 200,
    description: 'Producto marcado como no disponible',
  })
